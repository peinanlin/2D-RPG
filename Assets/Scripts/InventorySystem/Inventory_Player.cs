...
public class Inventory_Player : Inventory_Base
{
    ...
    public override void SaveData(ref GameData data)
    {
        ...
        data.quickSlot1ItemSaveId = quickItems[0]?.itemData?.saveId;
        data.quickSlot2ItemSaveId = quickItems[1]?.itemData?.saveId;
    }
    ...
    public override void LoadData(GameData data)
    {
        ...
        player.health.SetHealthToPercent(savedHealthPercent);
        quickItems[0] = FindSameItemBySaveId(data.quickSlot1ItemSaveId);
        quickItems[1] = FindSameItemBySaveId(data.quickSlot2ItemSaveId);
        TriggerUpdateUI();
    }
    private Inventory_Item FindSameItemBySaveId(string saveId)
    {
